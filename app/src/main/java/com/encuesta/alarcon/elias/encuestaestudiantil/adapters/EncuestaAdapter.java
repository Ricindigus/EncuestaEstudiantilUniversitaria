package com.encuesta.alarcon.elias.encuestaestudiantil.adapters;
...
public class EncuestaAdapter extends RecyclerView.Adapter<EncuestaAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(encuestas.get(position).getTipoCurso().equals("Teoría")){
            holder.imagenLaboratorio.setVisibility(View.GONE);
            holder.imagenPractica.setVisibility(View.GONE);
            holder.imagenTeoria.setVisibility(View.VISIBLE);
        }else if(encuestas.get(position).getTipoCurso().equals("Práctica")){
            holder.imagenLaboratorio.setVisibility(View.GONE);
            holder.imagenPractica.setVisibility(View.VISIBLE);
            holder.imagenTeoria.setVisibility(View.GONE);
        }else{
            holder.imagenLaboratorio.setVisibility(View.VISIBLE);
            holder.imagenPractica.setVisibility(View.GONE);
            holder.imagenTeoria.setVisibility(View.GONE);
        }
    }
