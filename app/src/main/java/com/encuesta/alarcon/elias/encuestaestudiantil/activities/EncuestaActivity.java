...
import com.encuesta.alarcon.elias.encuestaestudiantil.pojos.Respuesta;
...
public class EncuestaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgEncuesta = (ImageView) findViewById(R.id.encuesta_imagen);
...
//        showToolbar("Algoritmica I");
        ...
        cargaImagencurso(tipoCurso);
        showToolbar(nombreCurso);
...
//        });
    ...
    public void cargaImagencurso(String tipoCurso){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if(tipoCurso.equals("Práctica")){
                imgEncuesta.setImageDrawable(getResources().getDrawable(R.drawable.practica, getApplicationContext().getTheme()));
            }else if(tipoCurso.equals("Laboratorio")){
                imgEncuesta.setImageDrawable(getResources().getDrawable(R.drawable.laboratorio, getApplicationContext().getTheme()));
            }
        } else {
            if(tipoCurso.equals("Práctica")){
                imgEncuesta.setImageDrawable(getResources().getDrawable(R.drawable.practica));
            }else if(tipoCurso.equals("Laboratorio")){
                imgEncuesta.setImageDrawable(getResources().getDrawable(R.drawable.laboratorio));
            }
        }
    }
